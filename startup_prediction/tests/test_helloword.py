...
class TestStartupPredictor:
    """Tests the StartupPredictor class"""

    def test_startup_predictor(self) -> None:
...
if __name__ == '__main__':
    test_instance = TestStartupPredictor()
    test_instance.test_startup_predictor()
